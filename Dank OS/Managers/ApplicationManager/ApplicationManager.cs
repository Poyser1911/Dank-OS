...
namespace Dank_OS
{
    public class ApplicationManager
    {
        ...
        public MemoryManager mManager { get; set; } = MemoryManager.GetInstance;
        ...
        {
            File.AppendAllText("ProcessHistory.txt", $"{app.AppProcess.ProcessID} {app.AppName} {(app.IsSystemApp ? "System" : "User")} {app.AppProcess.StartTime.ToLongDateString()} {app.AppProcess.StartTime.ToLongTimeString()}  {app.AppProcess.EndTime.ToLongDateString()} {app.AppProcess.EndTime.ToLongTimeString()} {app.AppProcess.CpuTime}\n");
        }
        #endregion
    }
}
